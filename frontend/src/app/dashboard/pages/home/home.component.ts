    ...
    <div>
      ...
      @if (events().length === 0 && !loading()) {
        <div class="card text-center" style="padding:60px">
          ...
          <h3 style="margin:16px 0 8px;color:rgba(255,255,255,0.7)">No hay eventos creados</h3>
          <p class="text-muted" style="margin-bottom:24px">Crea tu primer evento para comenzar</p>
          <a routerLink="/dashboard/events" class="btn btn-primary">
